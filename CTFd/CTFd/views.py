...
from flask import redirect, render_template, request, send_file, session, url_for, make_response
...
def setup():
    ...
    <div class="col-md-6 offset-md-3">
        <img class="w-100 mx-auto d-block" style="max-width: 500px;padding: 50px;padding-top: 14vh;" src="/themes/core/static/img/LogoDarkMode.png?d=d3750946" />
        <h3 class="text-center">
            <p>Welcome to DevCTF Platform!!!</p>
            <p>Join the discord server now</p>
            <a href="https://discord.gg/wEKuy3s7cK"><i class="fab fa-discord fa-2x" aria-hidden="true"></i></a>&nbsp;
        </h3>
        <br>
        <h4 class="text-center">
            <a href="user">Click here</a> to login and setup your DevCTF Profile
        </h4>
    </div>
</div>"""
            page.content = index
...
# @views.route("/web/<int:challenge_num>/<path:route>", methods=["GET", "POST"])
# @authed_only
# @bypass_csrf_protection
# def get_challenge(challenge_num, route):
#     response = make_response()
#     response.headers['X-Accel-Redirect'] = "/webchallenge/{}/{}".format(
#         challenge_num, route)
#     return response
